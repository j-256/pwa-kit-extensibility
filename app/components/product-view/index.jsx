...
const ProductView = forwardRef(
    (
        ...
        const [activePromotionId, setActivePromotionId] =
            useState(undefined) // this is the hovered over promotion, set onOpen, removed onClose
            ...
            <Flex direction={'column'} data-testid="product-view" ref={ref}>
                ...
                <Flex direction={['column', 'column', 'column', 'row']}>
                    ...
                    <VStack align="stretch" spacing={8} flex={1}>
                        ...
                        {/* productPromotions is destructured from product.productPromotions
                            That loop will build each line. We will then call the setActivePromotionId method, which will prompt
                        ...
                        */}
                        {productPromotions &&
                            productPromotions.map(({ promotionId,
                                calloutMsg }) => (
                                <Tooltip
                                    onOpen={() => {
